/*
Семинар 10 Задача 3: Заданы 2 массива: info и data. В массиве info хранятся двоичные представления 
...
// перевод двоичных чисел заданных двумя массивами в массив десятичных чисел
//
{
...
int Powering(int b, int a)// Функция возведения в степень (рекурсия)
{
    if ( a<=0 )
        return 1;
